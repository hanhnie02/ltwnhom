                                    ...
                                    ;?>
                                        <figure class="slide-image">
                                            <picture>
                                                ...
                                                <img src="assets/<?php echo $row["img"];?>" >                                            </picture>
            ...
            <div >
                <div class="container">
                    <div class="heading text-center mb-4">
                        ...
                        <p style="font-family:roboto; color:black " class="title-desc">Dzô Tết - sale hết </p><!-- End .title-desc -->
                    </div><!-- End .heading -->
                        ...
                        <div class="col-lg-6 deal-col">
                            <div class="deal" style="background-image: url('assets/images/banners/index4.png');">
                                ...
                                <div class="deal-content">
                                    ...
                                    <a    style="fontfamily:roboto" href="product.php?id=<?php echo $row["sanpham_id"];?>" class="btn btn-link"><span>Mua ngay</span><i class="icon-long-arrow-right"></i></a>
                                </div><!-- End .deal-content -->

                                <div class="deal-bottom">
                                    <div style="font-family:roboto" class="deal-countdown" data-until="+10h"></div><!-- End .deal-countdown -->
                                </div><!-- End .deal-bottom -->
                            </div><!-- End .deal -->
                        </div><!-- End .col-lg-6 -->
                    ...
                    <div class="more-container text-center mt-3 mb-0">
                        ...
                        <a style="border-radius: 15px;" href="#products-sale-tab" class="btn btn-warning "><span>Xem thêm Deal</span><i class="icon-long-arrow-right"></i></a>
