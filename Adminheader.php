                    ...
                    <ul class="top-menu">
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a style style="font-family:roboto" href="index.php">Đăng xuất</a>
                                <li><a style style="font-family:roboto"
                                        href="http://localhost:81/ltwnhom/ProductAdmin" target="blank">Admin</a>
                    ...
                    <div class="header-search header-search-extended header-search-visible d-none d-lg-block">
                        ...
                        <form action="#" method="get">
                            <div class="header-search-wrapper search-wrapper-wide">
                                ...
                                <input type="search" style="font-family:roboto; font-size:15px" class="form-control"
                                    name="q" id="q" placeholder="Tìm kiếm sản phẩm ..." required>
            ...
            <div class="header-bottom sticky-header">
                <div class="container">
                    <div class="header-left">
                        <div class="dropdown category-dropdown">
                            <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown"
                                ...
                                title="Browse Categories" style="font-family:roboto; font-size:20px"> Danh mục sản phẩm
                                ...
                                <nav class="side-nav">
                                    <ul class="menu-vertical sf-arrows">
                                        ...
                                        if($result ->num_rows >0)
                                        {
                                            ...
                                            {
                                                ?>
                                        <li class="item-lead"><a style="font-family:roboto"
                                                href="#"><?php echo $row_danhmuc['tendanhmuc'];?></a></li>
                                        <?php
                                            $i++;
                                            }
                                        }
                    ...
                    <div class="header-right">
                        ...
                        <p style="font-family: roboto, Helvetica, sans-serif;">Xả kho<span class="highlight">&nbsp;Giảm
                                tới 30%</span></p>
                    </div>
                </div><!-- End .container -->
