                    ...
                    <div class="container">
                        <div class="row">
                                            ...
                                            <td class="product-col">
                                                <div class="product">
                                                    ...
                                                    <h3 class="product-title">
                                                        <a href="#" style=" font-family: roboto"><?php echo $value["name"];?></a>
                                            ...
                                            <td class="quantity-col">
                                                <div class="cart-product-quantity">
                                                    <form action="addtocart.php">
                                                        ...
                                                        <input type="number" name="slg" style=" font-family: roboto" class="form-control" value="<?php echo $value['slg']?>">
                                                        <button class="btn btn-outline-dark-0" text-align="center"><i class="icon-refresh"></i></button>
                                                    </form>
                            ...
                            <aside class="col-lg-3">
                                ...
                                <a href="category.php" class="btn btn-outline-dark-2 btn-block mb-3" style=" font-family: roboto"><span>Tiếp tục mua sắm</span><i class="icon-refresh"></i></a>
                            </aside><!-- End .col-lg-3 -->
                        </div><!-- End .row -->
                    </div><!-- End .container -->
                </div><!-- End .cart -->
