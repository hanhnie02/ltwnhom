...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2023 at 05:48 PM
...
INSERT INTO `blog` (`blog_id`, `blog_name`, `bog_image`, `blog_noidung`) VALUES
(1, 'LG mới đây vừa giới thiệu với người dùng những công nghệ màn hình mới nhất của hãng. ', 'images/blog/1.png', '\r\nĐầu tiên là tấm nền OLED 17 inch có thể gập cho laptop. Một trong những điểm nổi bật nhất của nó là màn hình gập này hoàn toàn không có nếp gấp ở giữa. Ngay cả khi bạn gấp hoặc mở nó hoàn toàn, bạn sẽ không thấy bất kỳ nếp gấp nào trong đó. Màn hình có thể được sử dụng theo nhiều cách khác nhau như gập làm đôi, mở ra giống như máy tính bảng hoặc màn hình di động. Chưa hết, màn hình này cũng hỗ trợ bút stylus để mang đến hiệu suất làm việc tốt hơn cho người dùng.\r\nLG cũng sẽ cung cấp các giải pháp màn hình ô tô với tấm nền OLED cỡ vừa và nhỏ với các công nghệ độc quyền quan trọng, bao gồm P-OLED và LTPS.'),
(2, 'Rò rỉ giá bán bộ ba Galaxy S23: Có thể không đổi so với Galaxy S22, bắt đầu từ 18.8 triệu đồng', 'images/blog/2.png', '\r\nTheo các tin đồn trước đây cho biết, Samsung sẽ mang đến một vài cải tiến nhỏ về thiết kế cho Galaxy S23 và S23+. Theo đó, hệ thống camera sau của hai điện thoại này sẽ không có khung viền bao quanh như Galaxy S22 Ultra, mang tới vẻ đẹp liền mạch và mắt bắt hơn. Trong khi ngoại hình của Galaxy S23 Ultra sẽ không thay đổi nhiều so với thế hệ trước. Máy vẫn có thân máy vuông vức, nam tính và đi kèm khe chứa bút S Pen.\r\nVề cấu hình, dòng Galaxy S23 năm nay được đồn đại sử dụng phiên bản ép xung của SoC Snapdragon 8 Gen 2 và đi kèm hệ thống tản nhiệt được nâng cấp. Chưa hết, model Galaxy S23 Ultra còn được cho là sẽ có camera 200MP mới. Cùng chờ xem nhé!'),
(3, 'OnePlus 11 chính thức ra mắt: Thiết kế mới, Snapdragon 8 Gen 2, sạc nhanh 100W', 'images/blog/3.png', 'OnePlus 11 sở hữu thiết kế cao cấp với màn hình và mặt lưng được làm từ kính, khung được làm từ kim loại. Thiết bị có khả năng kháng bụi kháng nước theo tiêu chuẩn IP54. Chiếc máy sở hữu lẫy trượt để điều chỉnh chế độ âm thanh và thiết kế module camera hoàn toàn mới.\r\nVề cấu hình, OnePlus 11 sử dụng bộ vi xử lý Qualcomm Snapdragon 8 Gen 2 đi kèm với đó là RAM LPDDR5x và bộ nhớ trong UFS 4.0. Chiếc máy sở hữu hệ thống tản nhiệt bằng chất lỏng. Khi bán ra điện thoại sẽ được cài đặt giao diện người dùng OxygenOS 13 trên nền hệ điều hành Android 13.'),
(4, 'iPhone 16 sẽ có RAM LPDDR5X nhanh hơn, chip A18 Bionic 3nm siêu mạnh', 'images/blog/4.png', 'Về bộ xử lý, chip A17 Bionic của iPhone 15 Pro sẽ dựa trên quy trình chip N3B của TSMC trong khi iPhone 16 sẽ đi kèm với chip A18 Bionic dựa trên quy trình 3nm. Như đã đề cập trước đó, Apple không muốn thay đổi loại RAM với dòng iPhone 15. Tuy nhiên, các mẫu iPhone 15 Pro cao cấp hơn dự kiến sẽ được nâng cấp dung lượng lên 8GB thay vì 6GB như thế hệ trước. Cải tiến này hứa hẹn sẽ mang tới trải nghiệm đa nhiệm tốt hơn cho người dùng.\r\nNgoài ra, dòng iPhone 2024 cũng sẽ sử dụng RAM LPDDR5X nhanh hơn. Để so sánh, iPhone 14 Pro có RAM LPDDR5 và công nghệ cũng sẽ được áp dụng trên loạt iPhone 15 Pro dự kiến ra mắt vào mùa thu năm nay.'),
(5, 'POCO C50 ra mắt: MediaTek Helio A22, pin 5000mAh, giá từ 1.8 triệu đồng', 'images/blog/5.png', 'Về cấu hình, thiết bị sử dụng bộ vi xử lý MediaTek Helio A22 đi kèm với đó là 2GB/3GB RAM LPDDR4x và 32GB bộ nhớ trong chuẩn eMMC 5.1. Người dùng có thể mở rộng thêm 512GB không gian lưu trữ thông qua khe đọc thẻ nhớ microSD. Khi bán ra thiết bị sẽ được cài đặt sẵn hệ điều hành Android 12 Go Edition.\r\n\r\nMặt lưng là nơi đặt bộ đôi camera bao gồm cảm biến chính độ phân giải 8MP và cảm biến đo độ sâu trường ảnh 0.3MP. Camera trước có độ phân giải 5MP.\r\nViên pin có dung lượng 5000mAh hỗ trợ sạc thường với công suất 10W. Một vài tính năng khác bao gồm SIM kép, 4G, WiFi, Bluetooth 5.0, GNSS, giắc âm thanh 3.5mm và cảm biến vân tay đặt ở mặt lưng. Chiếc máy nặng 192 gram và có kích thước là 164.9 x 76.45 x 9.09mm'),
...
(7, 'Google Pixel 7 Series', 'images/blog/7.png', 'Về cấu hình, Google Pixel 7 Series sẽ được trang bị con chip Tensor G2 do hãng tự phát triển và hai tùy chọn bộ nhớ 128GB và 256GB. Dung lượng RAM của hai phiên bản sẽ có sự chênh lệch, cụ thể Pixel 7 sẽ có 8GB RAM và Pixel 7 Pro sẽ có 12GB RAM.\r\n\r\nGoogle Pixel 7 sẽ sử dụng cảm biến chính 50MP cho ống kính chính kèm một ống kính góc siêu rộng. Trên Pixel 7 Pro, Google còn trang bị thêm cho phiên bản này một ống kính tele 48MP có khả năng zoom quang học gấp 5 lần.\r\nCác tin tức điện thoại về hai mẫu Google Pixel 7 và Pixel 7 Pro mới đây cũng đã được tiết lộ trước sự kiện Made by Google. Hai mẫu điện thoại này sẽ được trang bị tấm nền LTPO mới với độ phân giải đạt đến QHD+ và tần số quét tối đa 120HZ.');
...
ALTER TABLE `donhang`
  ...
  ADD KEY `fk_foreign_dh1` (`khach_id`),
  ADD KEY `fk_foreign_d` (`sanpham_id`);
...
--
ALTER TABLE `khachhang`
  MODIFY `khach_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `donhang`
  ADD CONSTRAINT `fk_foreign_d` FOREIGN KEY (`sanpham_id`) REFERENCES `sanpham` (`sanpham_id`),
  ADD CONSTRAINT `fk_foreign_dh` FOREIGN KEY (`sanpham_id`) REFERENCES `sanpham` (`sanpham_id`),
  ADD CONSTRAINT `fk_foreign_dh1` FOREIGN KEY (`khach_id`) REFERENCES `khachhang` (`khach_id`);
